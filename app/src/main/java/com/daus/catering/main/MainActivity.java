package com.daus.catering.main;
...
import com.daus.catering.history.HistoryOrderActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    List<com.daus.catering.main.ModelTrending> modelTrendingList = new ArrayList<>();
